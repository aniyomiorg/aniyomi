 ...
 */
class L2RPagerViewer(activity: WatcherActivity) : PagerViewer(activity) {
    /**
 ...
 */
class R2LPagerViewer(activity: WatcherActivity) : PagerViewer(activity) {
    /**
 ...
 */
class VerticalPagerViewer(activity: WatcherActivity) : PagerViewer(activity) {
    /**
