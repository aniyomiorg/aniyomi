...
import eu.kanade.tachiyomi.ui.watcher.viewer.WatcherProgressBar
...
/**
 * Holder of the webtoon watcher for a single page of a episode.
 *
...
class WebtoonPageHolder(
     ...
     * Page of a episode.
     */
    private var page: WatcherPage? = null
    ...
    private fun createProgressBar(): WatcherProgressBar {
        progressContainer = FrameLayout(context)
        frame.addView(progressContainer, MATCH_PARENT, parentHeight)

        val progress = WatcherProgressBar(context).apply {
            val size = 48.dpToPx
