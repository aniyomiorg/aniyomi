...
import eu.kanade.tachiyomi.ui.watcher.viewer.GestureDetectorWithLongTap
...
open class Pager(
    ...
    /**
     * Executes the given key event when this pager has focus. Just do nothing because the watcher
