...
import eu.kanade.presentation.category.components.AnimeCategoryContent
...
import eu.kanade.tachiyomi.ui.animecategory.AnimeCategoryPresenter.Dialog
import eu.kanade.tachiyomi.util.system.toast
import kotlinx.coroutines.flow.collectLatest

@Composable
fun AnimeCategoryScreen(
    presenter: AnimeCategoryPresenter,
    navigateUp: () -> Unit,
) {
    ...
    Scaffold(
        ...
        LaunchedEffect(Unit) {
            presenter.events.collectLatest { event ->
                when (event) {
                    is AnimeCategoryPresenter.Event.CategoryWithNameAlreadyExists -> {
                        context.toast(R.string.error_category_exists)
                    }
                    is AnimeCategoryPresenter.Event.InternalError -> {
