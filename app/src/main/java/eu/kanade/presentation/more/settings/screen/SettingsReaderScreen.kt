        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = listOf(
                ...
                Preference.PreferenceItem.SwitchPreference(
                    ...
                    title = localize(MR.strings.pref_preserve_reading_position),
                ),
            ),
        )
    }
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = listOf(
                ...
                Preference.PreferenceItem.ListPreference(
                    ...
                    entries = mapOf(
                        ReaderPreferences.TappingInvertMode.NONE to localize(MR.strings.none),
                        ReaderPreferences.TappingInvertMode.HORIZONTAL to localize(
                            MR.strings.tapping_inverted_horizontal,
                        ),
                        ReaderPreferences.TappingInvertMode.VERTICAL to localize(
                            MR.strings.tapping_inverted_vertical,
                        ),
                        ReaderPreferences.TappingInvertMode.BOTH to localize(
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = listOf(
                ...
                Preference.PreferenceItem.ListPreference(
                    ...
                    entries = mapOf(
                        ReaderPreferences.ReaderHideThreshold.HIGHEST to localize(
                            MR.strings.pref_highest,
                        ),
                        ReaderPreferences.ReaderHideThreshold.HIGH to localize(
                            MR.strings.pref_high,
                        ),
                        ReaderPreferences.ReaderHideThreshold.LOW to localize(
                            MR.strings.pref_low,
                        ),
                        ReaderPreferences.ReaderHideThreshold.LOWEST to localize(
