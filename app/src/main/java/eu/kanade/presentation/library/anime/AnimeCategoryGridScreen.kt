...
sealed interface AnimeCategoryGridItem {
    data class Group(val category: Category, val coverAnime: AnimeCover?) : AnimeCategoryGridItem
    data class Entry(val libraryItem: AnimeLibraryItem) : AnimeCategoryGridItem
...
fun AnimeCategoryGridScreen(
    items: List<AnimeCategoryGridItem>,
    columns: Int,
    ...
    LazyVerticalGrid(
        ...
        items(
            ...
            when (item) {
                is AnimeCategoryGridItem.Group -> {
                    Column(
                        modifier = Modifier
                            .clickable { onGroupClick(item.category) }
                            .padding(4.dp),
                ...
                is AnimeCategoryGridItem.Entry -> {
